...
// Validate ../../../src/app/api/bulk-match/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/bulk-match">> = Specific
  const handler = {} as typeof import("../../../src/app/api/bulk-match/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
