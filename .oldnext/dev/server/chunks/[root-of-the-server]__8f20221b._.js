...
"[project]/src/app/api/candidates/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function DELETE(request) {
    try {
        ...
        const candidateIndex = database.candidates.findIndex((c)=>c.id === id);
        if (candidateIndex === -1) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        if (database.matches) {
            database.matches = database.matches.filter((m)=>m.candidateId !== id);
        }
        // Save database
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8f20221b._.js.map